...
function api_v1_customtext_update(action) {
  return testappAPI.put(`/api/v1/customtext/${action.id}/`, {
    data: action.data
  })
}
function api_v1_customtext_partial_update(action) {
  return testappAPI.patch(`/api/v1/customtext/${action.id}/`, {
    data: action.data
  })
}
...
function api_v1_homepage_update(action) {
  return testappAPI.put(`/api/v1/homepage/${action.id}/`, { data: action.data })
}
function api_v1_homepage_partial_update(action) {
  return testappAPI.patch(`/api/v1/homepage/${action.id}/`, {
    data: action.data
  })
}
...
function api_v1_signup_create(action) {
  return testappAPI.post(`/api/v1/signup/`, { data: action.data })
}
function rest_auth_login_create(action) {
  return testappAPI.post(`/rest-auth/login/`, { data: action.data })
}
...
function rest_auth_password_change_create(action) {
  return testappAPI.post(`/rest-auth/password/change/`, { data: action.data })
}
function rest_auth_password_reset_create(action) {
  return testappAPI.post(`/rest-auth/password/reset/`, { data: action.data })
}
function rest_auth_password_reset_confirm_create(action) {
  return testappAPI.post(`/rest-auth/password/reset/confirm/`, {
    data: action.data
  })
}
function rest_auth_registration_create(action) {
  return testappAPI.post(`/rest-auth/registration/`, { data: action.data })
}
function rest_auth_registration_verify_email_create(action) {
  return testappAPI.post(`/rest-auth/registration/verify-email/`, {
    data: action.data
  })
}
...
function rest_auth_user_update(action) {
  return testappAPI.put(`/rest-auth/user/`, { data: action.data })
}
function rest_auth_user_partial_update(action) {
  return testappAPI.patch(`/rest-auth/user/`, { data: action.data })
}
